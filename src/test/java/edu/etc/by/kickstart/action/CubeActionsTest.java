...
public class CubeActionsTest {
    private static final CubeActionImpl actions = new CubeActionImpl();
    private static final Cube inputCubeSimpleData = new Cube(0,
    ...
    private static final Cube inputCubeComplexData = new Cube(0,
